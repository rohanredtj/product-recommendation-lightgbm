...
#     CV Evaluation
    ...
    print("CV accuracy Mean:", round(np.mean(np.array(acc_scores)),2), file=report_object)
    
    print("CV recall each fold:", rec_scores, file=report_object)
    print("CV recall Mean:", round(np.mean(np.array(rec_scores)),2), file=report_object)
